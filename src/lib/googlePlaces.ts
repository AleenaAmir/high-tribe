...
export function convertGooglePlaceToMapboxFormat(googlePlace: GooglePlaceDetails) {
  return {
    id: googlePlace.place_id,
    place_name: googlePlace.formatted_address,
    center: [googlePlace.geometry.location.lng, googlePlace.geometry.location.lat],
