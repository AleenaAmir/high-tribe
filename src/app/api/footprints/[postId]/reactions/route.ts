...
export async function POST(
  ...
  try {
    ...
    // Add the reactionable_type for footprints
    formData.append('reactionable_type', 'App\\Models\\Footprint');
    ...
    const response = await fetch(`${backendUrl}/footprints/${postId}/reactions`, {
      method: 'POST',
      headers: {
