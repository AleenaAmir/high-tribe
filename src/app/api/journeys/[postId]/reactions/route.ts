...
export async function POST(
  ...
  try {
    ...
    // Add the reactionable_type for journeys
    formData.append('reactionable_type', 'App\\Models\\Journey');
    ...
    const response = await fetch(`${backendUrl}/journeys/${postId}/reactions`, {
      method: 'POST',
      headers: {
