...
export async function POST(
  ...
  try {
    ...
    // Add the reactionable_type for advisories
    formData.append('reactionable_type', 'App\\Models\\Advisory');
    ...
    const response = await fetch(`${backendUrl}/advisories/${postId}/reactions`, {
      method: 'POST',
      headers: {
