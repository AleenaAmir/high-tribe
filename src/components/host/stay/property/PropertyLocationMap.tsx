...
export interface PropertyLocationMapRef {
...
const PropertyLocationMap = React.memo(
  forwardRef<PropertyLocationMapRef, PropertyLocationMapProps>(
    ({ onLocationSelect, selectedLocation, className = "" }, ref) => {
      ...
      useEffect(() => {
        ...
        if (selectedLocation?.coords) {
          ...
          markerEl.style.background = "#257CFF";
          markerEl.style.border = "3px solid #fff";
          markerEl.style.boxShadow = "0 4px 12px rgba(37, 124, 255, 0.4)";
        ...
        `;
          ...
          <div style="padding: 16px; min-width: 250px;">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="#257CFF">
                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
              </svg>
              <h3 style="font-size: 16px; font-weight: 600; margin: 0; color: #333;">Property Location</h3>
            </div>
      ...
      return (
        <div className={`relative ${className}`}>
          ...
          />
          <style jsx global>{`
            .property-location-popup .mapboxgl-popup-content {
              padding: 0;
              border-radius: 12px;
            ...
            .property-location-popup .mapboxgl-popup-tip {
