...
const GlobalTextArea: React.FC<GlobalTextAreaProps> = ({
  ...
  return (
    <div className={`flex flex-col gap-1 ${className}`}>
      ...
      <textarea
        {...props}
        className={`rounded-lg border px-5 py-3 text-[12px] placeholder:text-[#AFACAC] focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all resize-none ${
