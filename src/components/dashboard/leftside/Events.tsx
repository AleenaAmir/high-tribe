                    ...
                    />
                              ...
                              <div className="space-y-2">
                                {trips.map((trip) => (
                                  <div 
                                    key={trip.id}
                                    className={`flex justify-between items-center px-4 py-2.5 rounded-full border transition-all duration-200 hover:shadow-sm relative ${
                                      trip.isHighlighted 
                                  ...
                                  >
                                    <span className={`text-xs text-center ${
                                      trip.isHighlighted ? 'text-[#000000] font-sm' : 'text-[#000000]'
                                    }`}>
                                      {trip.title}
                                    </span>
                                    <span className={`text-[10px] text-center ml-4 ${
                                      trip.isHighlighted ? 'text-[#FF0202] font-sm' : 'text-[#4E4949]'
                                    }`}>
                                      {trip.date}
                                    </span>
                                  </div>
